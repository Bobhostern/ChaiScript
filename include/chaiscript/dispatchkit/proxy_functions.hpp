  ...
  namespace dispatch
  {
    ...
    class Dynamic_Proxy_Function : public Proxy_Function_Base
    {
      public:
        ...
        virtual bool call_match(const std::vector<Boxed_Value> &vals, const Type_Conversions &t_conversions) const override
        {
    ...
    class Dynamic_Proxy_Function_Impl : public Dynamic_Proxy_Function
    {
      ...
      protected:
        virtual Boxed_Value do_call(const std::vector<Boxed_Value> &params, const Type_Conversions &t_conversions) const override
        {
      ...
      class Proxy_Function_Callable_Impl : public Proxy_Function_Impl_Base
    {
      public:
        ...
        virtual bool compare_types_with_cast(const std::vector<Boxed_Value> &vals, const Type_Conversions &t_conversions) const override
        {
      ...
      class Assignable_Proxy_Function_Impl : public Assignable_Proxy_Function
    {
      public:
        ...
        virtual void assign(const std::shared_ptr<const Proxy_Function_Base> &t_rhs) override {
      ...
      class Attribute_Access : public Proxy_Function_Base
    {
      public:
        ...
        virtual bool is_attribute_function() const override { return true; } 
        ...
        virtual bool call_match(const std::vector<Boxed_Value> &vals, const Type_Conversions &) const override
        {
          if (vals.size() != 1)
          {
            return false;
